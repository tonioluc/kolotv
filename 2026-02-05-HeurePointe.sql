...
-- Lundi 6 à 7 , 8 à 9 , 17 à 18
INSERT INTO HEUREPOINTE (ID, HEUREDEBUT, HEUREFIN, POURCENTAGEMAJORATION, DESIGNATION, ETAT, IDSUPPORT, JOURSEMAINE)
VALUES ('HPT005', '06:00:00', '07:00:00', 10, 'Heure de pointe du matin - Lundi', 11, NULL, 1);

INSERT INTO HEUREPOINTE (ID, HEUREDEBUT, HEUREFIN, POURCENTAGEMAJORATION, DESIGNATION, ETAT, IDSUPPORT, JOURSEMAINE)
VALUES ('HPT006', '08:00:00', '09:00:00', 10, 'Heure de pointe du matin - Lundi', 11, NULL, 1);

INSERT INTO HEUREPOINTE (ID, HEUREDEBUT, HEUREFIN, POURCENTAGEMAJORATION, DESIGNATION, ETAT, IDSUPPORT, JOURSEMAINE)
VALUES ('HPT007', '17:00:00', '18:00:00', 10, 'Heure de pointe du matin - Lundi', 11, NULL, 1);
...
UPDATE MENUDYNAMIQUE SET ID_PERE = 'ELM001104001', NIVEAU = 2 WHERE ID = 'MNDN_HP_001';
UPDATE MENUDYNAMIQUE SET NIVEAU = 3 WHERE ID IN ('MNDN_HP_002', 'MNDN_HP_003');
COMMIT;
