-- Modification de la vue VENTE_DETAILS_CPL_2_VISEE pour ajouter la colonne moisAnnee
-- Date: 2026-02-12
-- Auteur: Modification pour analyse mensuelle
...
SELECT vd.ID,
       ...
       TO_CHAR(v.DATY, 'MM/YY') AS moisAnnee,
       TO_CHAR(v.DATY, 'YYYY') AS annee,
       TO_NUMBER(TO_CHAR(v.DATY, 'YYYYMM')) AS moisAnneeTri
