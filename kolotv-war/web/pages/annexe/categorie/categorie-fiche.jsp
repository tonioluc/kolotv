...
%>
<%
    CategorieLib  categorie = new CategorieLib();
    categorie.setNomTable("CATEGORIELIB");
    ...
    String pageModif = "annexe/categorie/categorie-modif.jsp";
    String classe = "annexe.CategorieLib";
%>
