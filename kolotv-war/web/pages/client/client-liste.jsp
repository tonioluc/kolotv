...
<% try{
    ...
    String listeCrt[] = {"id","nom","telephone","mail","adresse","remarque","type","daty"};
    String listeInt[] = {"daty"};
    String libEntete[] = {"id","nom","telephone","mail","adresse","remarque","type","daty"};
    ...
    String libEnteteAffiche[] = {"ID", "Nom", "T&eacute;l&eacute;phone","Adresse e-mail","Adresse","Remarque","Type","Date"};
