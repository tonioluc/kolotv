...
<%
    ...
    String  mapping = "emission.TypeMedia",
            nomtable = "TypeEmission",
            apres = "emission/typeemission-fiche.jsp",
            titre = "Modification type d'emission";
            ...
            <div class="box-fiche">
                <div class="box">
                    <div class="box-title with-border">
                        <h1 class="box-title"><a href=<%= lien + "?but=emission/typeemission-fiche.jsp&id="+id%> <i class="fa fa-arrow-circle-left"></i></a><%=pu.getTitre()%></h1>
                    </div>
