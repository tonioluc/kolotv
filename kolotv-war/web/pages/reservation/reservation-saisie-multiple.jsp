...
<div class="content-wrapper">
  ...
  <form action="<%=lien%>?but=apresReservation.jsp" method="post" name="<%=nomtable%>" id="<%=nomtable%>">
    <input name="acte" type="hidden" id="nature" value="insertReservationMultiple">
...
<script>
  ...
  function addLigne(nb) {
    ...
    if (listDate.length>0){
      for (let i = 0; i < nb; i++) {
        createLigne(dernierChampServiceLib,dernierChampService,dernierChampPu,dernierChampDuree,dernierChampMedia,dernierChampMediaLib,dernierChampSource,dernierChampRemarque,dernierChampListDate,nbLigne,listDate,listChamp.length);
        nbLigne += 1;
      }
    }
  ...
  function createLigne (dernierChampServiceLib,dernierChampService,dernierChampPu,dernierChampDuree,dernierChampMedia,dernierChampMediaLib,dernierChampSource,dernierChampRemarque,dernierChampListDate,id,listDate,totalNbLigne){
    var champs = Array("idproduit_"+id,"idmedia_"+id,"heure_"+id,"remarque_"+id,"date_"+id,"duree_"+id,"pu_"+id,"source_"+id,"isEntete_"+id,"listDate_"+id);
