...
<%
    ...
    String listeCrt[] = {};
    String listeInt[] = {};
    String libEntete[] = {"id","idClientLib","daty","remarque","montanttotal","montanttva","montantttc","montantpaye","montantreste"};
    ...
    <div class="w-100" style="display: flex; flex-direction: row-reverse;">
        <table style="width: 20%"class="table">
            <tr>
                ...
                <td><b><%= utilitaire.Utilitaire.formaterAr(AdminGen.calculSommeDouble(pr.getListe(),"montanttotal")) %> <%= idDevise %></b></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><b><%= utilitaire.Utilitaire.formaterAr(AdminGen.calculSommeDouble(pr.getListe(),"montantpaye")) %> <%= idDevise %></b></td>
            </tr>
            <tr>
                <td><b>Reste a payer:</b></td>
                <td><b><%= utilitaire.Utilitaire.formaterAr(AdminGen.calculSommeDouble(pr.getListe(),"montantreste")) %> <%= idDevise %></b></td>
            </tr>
        </table>
    </div>
    <% }if(pr.getTableau().getHtml() == null){
